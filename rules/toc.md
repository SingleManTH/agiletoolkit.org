...
* Use "&", not "and"
* Indent code blocks 1 tab or 4 spaces
...
((I've put in some sample URLs. Are these on the right lines?))

* Installing Agile Toolkit 							[/install]
    + Requirements										[/install/requirements]
	+ Installing With Composer 							[/install/composer]
    + Installing Manually 								[/install/manual]
	+ Starting A New Project 							[/install/new]
